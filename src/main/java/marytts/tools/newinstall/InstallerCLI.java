...
public class InstallerCLI {
  ...
  public static void main(String[] args) {
    ...
    options.addOption("l", "list", false,
      "list all available voice components");
  ...
  private static void listAllComponents(List<Component> resources) {
    ...
    for (Component oneComp : resources) {
      ...
      if (!prevLang.equals(oneComp.getLocale().toString())) {
        sb.append("##" + oneComp.getLocale().toString() + " - "
          + oneComp.getLocale().getDisplayLanguage() + "##\n");
      }
  ...
  // /**
  // *
  // * Comparator for sorting voice components in following order: locale >
  // gender
  // * > name
  // *
  // * @author Jonathan
  // *
  // */
  // class VoiceComponentComparator<Component> implements Comparator<Component>
  // {
  //
  // @Override
  // public int compare(Object c1, Object c2) {
  //
  // Component c1C = (Component)c1;
  // Component c2C = (Component)c2;
  //
  //
  // }
